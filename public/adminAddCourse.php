            ...
            <div class="col-lg-9 col-md-11">
                <div class="p-1">
                    <div class="card">
                        ...
                        <form action="../src/admin/adminAddCourse.php" method="POST">
                                        ...
                                        <div class="col-12 col-md-6 mt-md-0 mt-3 text-md-end">
                                            <div class="p-1">
                                                <?php
                                                    if($_GET['return'] == '\'fail\''){
                                                ?>
                                                        <span class="text-light bg-danger p-md-3 p-2 rounded-pill ">Cannot Add Course</span>
                                                <?php
                                                    }
                                                    elseif($_GET['return'] == '\'success\''){
                                                ?>
                                                        <span class="text-light bg-success p-md-3 p-2 rounded-pill">Course Added</span>
                                                <?php
                                                    }
                                                ?>
                                            </div>
