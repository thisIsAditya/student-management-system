...
<?php 
    ...
    $stdn_id = $_GET['id'];
    $sql = "SELECT * FROM `student` WHERE `stdn_id`=$stdn_id";
            ...
            <div class="col-lg-9 col-md-11">
                <div class="p-1">
                    <div class="card">
                        ...
                        <form action="../src/admin/adminEditStudent.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-center" style="height:20rem; overflow:auto;">
                                    <div class="col-3">
                                        <div class="my-md-2 p-2">
                                            <img src="<?php if(isset($r['student_img'])){echo $r['student_img'];} ?>" class="img-thumbnail rounded-circle" alt="Profile Picture">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control" name="rollno" value="<?php if(isset($r['rollno'])){echo $r['rollno'];} ?>">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="name">Name</label>
                                            <input type="text" class="form-control" name="name" value="<?php if(isset($r['name'])){echo $r['name'];} ?>">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="email">E-mail</label>
                                            <input type="text" class="form-control" name="email" value="<?php if(isset($r['email'])){echo $r['email'];} ?>">
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="pcont">Parent's Contact Number</label>
                                            <input type="text" class="form-control" name="pcont" value="<?php if(isset($r['pcont'])){echo $r['pcont'];} ?>">
                                        </div>
                            ...
                            <div class="card-footer">
                                <div class="container-fluid">
                                    <div class="row align-items-center">
                                        <div class="col-md-6 ">
                                            <div class="p-1">
                                                <input type="hidden" name="student_id" value="<?= $stdn_id ?>">
                                                <button type="submit" class="btn btn-danger" name="editStdSubmitBtn">Save</button>
                                        ...
                                        <div class="col-12 col-md-6 mt-md-0 mt-3 text-md-end">
                                            <div class="p-1">
                                                <?php
                                                    if($_GET['return'] == '\'fail\''){
                                                ?>
                                                        <span class="text-light bg-danger p-md-3 p-2 rounded-pill ">Cannot Edit Student</span>
                                                <?php
                                                    }
                                                    elseif($_GET['return'] == '\'success\''){
                                                ?>
                                                        <span class="text-light bg-success p-md-3 p-2 rounded-pill">Edited</span>
                                                <?php
